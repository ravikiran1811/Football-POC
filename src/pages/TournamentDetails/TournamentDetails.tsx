...
<TournamentDetais tournamentName={tournamentDetails[0].name} tournamentAgeGroup={tournamentDetails[0].age} tournamentLevel={tournamentDetails[0].level}
        tournamentClubAssociated={tournamentDetails[0].clubAssociated} tournamentPrize={tournamentDetails[0].prize} tournamentUpcomingMatch={tournamentDetails[0].upcomingMatch}/>    <Box className={TournamentDetailsStyles.summarySection}>
    <SummarySection
