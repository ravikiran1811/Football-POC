  ...
  return (
    ...
    <Box className={TournamentDetailsKeyHighlightsStyles.mainContainer}>
     <Box className={TournamentDetailsKeyHighlightsStyles.topContainer}>
      ...
      return  <Box className={TournamentDetailsKeyHighlightsStyles.Image}>
            <img src={each.imageLink} alt="" />
            <Box className={each.id === 3 ? TournamentDetailsKeyHighlightsStyles.thirdHighlight :  TournamentDetailsKeyHighlightsStyles.highlight}>
            <Box className={TournamentDetailsKeyHighlightsStyles.arrow}>
              <img src={each.id ===3 ?upArrow:arrow} alt="" />
            </Box>
            <Box className={TournamentDetailsKeyHighlightsStyles.content}>
            <Typography  className={TournamentDetailsKeyHighlightsStyles.year}>{each.year}</Typography>
            <Typography className={TournamentDetailsKeyHighlightsStyles.highlightText}>{each.description}</Typography>
            </Box>
            </Box>
          </Box>
      })}
      ...
      { bottomContainer && Array.isArray(bottomContainer)  && bottomContainer.length!=0 && bottomContainer.map((each:any)=>{
      return  <Box className={TournamentDetailsKeyHighlightsStyles.Image}>
            <img src={each.imageLink} alt="" />
            <Box className={TournamentDetailsKeyHighlightsStyles.highlight}>
            <Box className={TournamentDetailsKeyHighlightsStyles.arrow}>
